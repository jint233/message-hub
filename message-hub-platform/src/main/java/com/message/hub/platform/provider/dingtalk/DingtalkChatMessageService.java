...
public class DingtalkChatMessageService extends AbstractSendService<DingtalkProperties.Chat> {
     ...
     */
    @Override
    public String sendMarkdown(DingtalkProperties.Chat chat, MarkdownContext context) {
        Map<String, Object> params = context.getContentParams(chat.getAlias()).getDingtalkMessage();
     ...
     */
    @Override
    public String sendText(DingtalkProperties.Chat chat, TextContext context) {
        Map<String, Object> params = context.getContentParams(chat.getAlias()).getDingtalkMessage();
        OapiMessageCorpconversationAsyncsendV2Request request = this.request(chat.getAgentId(), params);
        OapiMessageCorpconversationAsyncsendV2Request.Msg msg = new OapiMessageCorpconversationAsyncsendV2Request.Msg();
        msg.setMsgtype("text");
